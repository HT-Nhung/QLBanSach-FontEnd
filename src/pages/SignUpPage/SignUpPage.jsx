...
import imageLogo from '../../assets/images/muasam.jpg'
...
const SignUpPage = () => {
    ...
    return (
        <div style={{
            ...
            background: 'rgb(0, 0, 0, 0.53', height: '100vh'
        }}>
            <div style={{
                width: '800px', height: '455px', borderRadius: '6px',
                ...
                <WrapperContainerLeft>
                    ...
                    <Loading isLoading={isLoading}>
                        <ButtonComponent
                            ...
                            size={40}
                            styleButton={{
                                background: 'red', height: '48px', width: '100%',
                                border: 'none', borderRadius: '4px', margin: '26px 0 10px'
                            }}
